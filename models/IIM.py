...
class IIBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        feats = self.feat_projector(x)  #b, 24, h ,w
...
if __name__ == '__main__':
    ...
    # images = cv2.imread('../dark_img/00001.jpg')
    ...
    # input_p = torch.randn(1, 3, 640, 640)#.to(device)
    # flops, params = thop.profile(model, inputs=(input_p,), verbose=False)
